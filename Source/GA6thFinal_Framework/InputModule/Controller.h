...
namespace Input
{
    ...
    public:
        ...
        void Vibrate(ControllerTypes::MotorSpeed leftMotorSpeed, ControllerTypes::MotorSpeed rightMotorSpeed, std::chrono::milliseconds duration) const;

        /// <summary>
        /// 컨트롤러에 지정된 진동을 적용합니다.
        /// </summary>
        /// <param name="vibration">적용할 진동 설정을 나타내는 ControllerTypes::Vibration 객체입니다.</param>
        void Vibrate(const ControllerTypes::Vibration& vibration) const;
