...
namespace Input
{
    ...
    Controller::ID Adapter::Connect() const noexcept
    {
    ...
    Controller::State Adapter::ReceiveState(const Controller::ID id) const
    {
    ...
    std::vector<Controller::Button> Adapter::ReceiveQueue(const Controller::ID id) const
    {
        constexpr ThrowIfFailed throwIfFailed;
    ...
    Controller::TriggerValue Adapter::NormalizeTrigger(const BYTE triggerValue, const BYTE thresholdValue)
    {
    ...
    Controller::ThumbStickAxis Adapter::NormalizeStick(const SHORT xValue, const SHORT yValue,
