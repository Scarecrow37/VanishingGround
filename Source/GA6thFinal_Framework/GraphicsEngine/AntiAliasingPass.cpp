                                  ...
                                  ID3D12GraphicsCommandList* commandList)
{
    ...
    UINT alignedSize = (sizeof(FXAAData) + 255) & ~255;
    _constantBuffer = std::make_unique<ConstantBufferView>();
    _constantBuffer->Initialize(alignedSize);
}
...
void AntiAliasingPass::Begin(ID3D12GraphicsCommandList* commandList) 
{
    ...
    _constantBuffer->UpdateBuffer(&fxaaData);
}
...
void AntiAliasingPass::Draw(ID3D12GraphicsCommandList* commandList)
{
    ...
    commandList->SetGraphicsRootConstantBufferView(_fx.GetRootParameterIndex("fxaaData"),
                                                   _constantBuffer->GetGPUVirtualAddress());
