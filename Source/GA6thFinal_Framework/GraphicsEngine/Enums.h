...
enum FrameResourceType { TRANSFORM, BONE_MATRICES, UI_TRANSFORM, UI_MATERIAL, TEXT_TRANSFORM, VERTEX_BUFFER_ID, INDEX_BUFFER_ID, MESH_INSTANCE_ID, FRAME_TYPE_END };
