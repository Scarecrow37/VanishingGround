...
void ParticleEffectSerializer::Serialize(ParticleEffect* effect, const std::filesystem::path& destPath)
{
...
ParticleEffect* ParticleEffectSerializer::Deserialize(const std::filesystem::path& filepath)
{
    ...
    auto newEffect = Global::particleManager->RegisterEffect();
    ...
    for (uint32_t i = 0; i < emitterCount; ++i)
    {
        ...
        {
            auto emitter =
                Global::particleManager->RegisterEmitter(newEffect, maxParticles, emissionRate, emitterLifetime, locationType,
