...
// Note: This file has been reordered to match the structure of ParticleManager.cpp
// The internal logic and memory management model of the original ParticleManager_1.cpp have been preserved.
...
ParticleManager::~ParticleManager()
{
    ...
    for (ParticleUpdateResource* updateResource : _particleUpdateResources)
    {
        if (updateResource)
        {
            ...
            updateResource->_sceneEffects.clear();
            delete updateResource;
        }
    }
    _particleUpdateResources.clear();
...
void ParticleManager::TurnOffEditorMode()
{
    delete _sceneResources["ParticleEditor"]._renderResource;
    _sceneResources.erase("ParticleEditor");
}