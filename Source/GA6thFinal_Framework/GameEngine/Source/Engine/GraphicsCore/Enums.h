...
enum CommandListType { MESH_COMPUTE_LIST, MESH_RENDER_LIST, PARTICLE_COMPUTE_LIST, PARTICLE_RENDER_LIST, IMGUI_RENDER_LIST, POST_PROCESS_LIST, COMMAND_LIST_END };

enum FenceType { MESH_COMPUTE_FENCE, PARTICLE_COMPUTE_FENCE,MESH_RENDER_FENCE, PARTICLE_RENDER_FENCE, POST_PROCESS_FENCE, FENCE_END };
