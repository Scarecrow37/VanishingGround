...
void ParticleRenderTechnique::CreateWBOITResources()
{
...

    {
        ...
        // cpuheapstart.ptr +=
        // UmDevice.GetDevice()->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
        ...
        // UmDevice.GetDevice()->CreateShaderResourceView(_accumlateBuffer.Get(), &accumlateSRVDesc,
        ...
        // UmDevice.GetDevice()->CreateShaderResourceView(_revealageBuffer.Get(), &revealageSRVDesc,
