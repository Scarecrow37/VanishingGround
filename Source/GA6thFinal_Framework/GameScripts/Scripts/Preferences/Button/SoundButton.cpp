...
void SoundButton::Reset()
{
    ...
    BindInputAction(ControllerButton::DPAD_LEFT, Action::PRESSED, this, &SoundButton::ControlVolumeUp);
    BindInputAction(ControllerButton::DPAD_RIGHT, Action::PRESSED, this, &SoundButton::ControlVolumeDown);
