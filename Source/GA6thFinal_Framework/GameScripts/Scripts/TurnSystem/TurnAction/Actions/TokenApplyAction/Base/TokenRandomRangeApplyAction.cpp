...
#include "TokenRandomRangeApplyAction.h"
#include "Token/TokenSystem.h"
#include "TurnSystem/TurnSystemHelper.h"

TokenRandomRangeApplyAction::TokenRandomRangeApplyAction()
{
    ReflectFields->TokenID = TokenObject::Bleed::ID;
}

REFLECT_FUNCTION(TokenRandomRangeApplyAction)

void TokenRandomRangeApplyAction::ImGuiDrawPropertysEvent()
{
    ImGui::Text("Action");
    ...
    ReflectHelper::ImGuiDraw::Private::InputAuto(TokenCountMin, UmCore->ImGuiDrawPropertysSetting);
    ReflectHelper::ImGuiDraw::Private::InputAuto(TokenCountMax, UmCore->ImGuiDrawPropertysSetting);
...
void TokenRandomRangeApplyAction::TryTokenSystemInfoUpdate()
{
