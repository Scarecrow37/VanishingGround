...
#include "CombatStartTokenApplyAction.h"
...
REGISTER_TURN_ACTION(CombatStartTokenApplyAction)

const std::string& CombatStartTokenApplyAction::GetActionInfo()
{
    TryTokenSystemInfoUpdate();
    return _actionInfo;
}

void CombatStartTokenApplyAction::ImGuiDrawActionEditor()
{
    ImGuiDrawPropertys();
}

const std::string& CombatStartTokenApplyAction::GetActionName()
{
    static const std::string name = (const char*)u8"전투 시작시 대상에게 토큰 부여";
    return name;
}

void CombatStartTokenApplyAction::OnCombatStart()
{
...
void CombatStartTokenApplyAction::UpdateActionInfo()
{
