...
public:
    ...
    public:
        ConditionNode(
            std::string_view label,
            std::string_view trueNode,
            std::string_view falseNode,
...
public:
    ...
    void PushActionNode(std::string_view label, std::string_view nextNode, std::initializer_list<ActionData> actions);
    ...
    /// <param name="condition">조건을 확인할 함수입니다.</param>
