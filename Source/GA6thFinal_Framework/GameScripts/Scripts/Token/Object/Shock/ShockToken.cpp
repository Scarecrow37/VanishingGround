...
namespace TokenObject
{
    ...
    REGISTER_TOKEN(ShockResistance1)
    REGISTER_TOKEN(ShockResistance2)
    REGISTER_TOKEN(ShockResistance3)
    ...
    void ShockResistance1::OnTurnStart(CharacterBase* owner) {}

    void ShockResistance2::OnTurnStart(CharacterBase* owner) {}

    void ShockResistance3::OnTurnStart(CharacterBase* owner) {}
} // namespace TokenObject