...
enum AnimationFlag
{
    ...
    ANIMATION_FLAG_ALWAYS_UPDATE = 1 << 2, // 항상 업데이트 애니메이션(OverrideAnimation은 마지막 프레임만 업데이트 하지만, 해당 bool값을 true로 할 경우 해당 애니메이션도 업데이트)
};
...
struct AnimationData
{
    ...
    AnimationFlags Flags        = ANIMATION_FLAG_NONE; // 애니메이션 플래그
